 ...
 * (categories ui.md states, STD-FE-031), matching the product list skeleton.
 */
@Component({
  selector: 'app-category-list-skeleton',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [VfSkeletonComponent],
  template: `
    <div class="skeleton-table" role="status" [attr.aria-label]="t.t('categories.loading')">
...
export class CategoryListSkeletonComponent {
