 ...
 * (sales ui.md states, STD-FE-031).
 */
@Component({
  selector: 'app-sales-list-skeleton',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [VfSkeletonComponent],
  template: `
    <div class="skeleton-table" role="status" [attr.aria-label]="t.t('salesList.loading')">
...
export class SalesListSkeletonComponent {
