...
/// <summary>
/// Front-line validation of the create request (REQ-CAT-043, AC-CAT-043): each
/// missing mandatory-minimum field (BR-CAT-009) produces its own field-keyed
/// error so the UI can highlight exactly what is missing (ui.md §5). The domain
/// aggregate re-enforces every rule as the backstop (STD-BE-010). Messages are
/// resource keys; the API middleware is the single translation point.
/// </summary>
