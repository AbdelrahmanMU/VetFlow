...
**Updated:** 2026-07-22 (Slice 5 — Purchase Receiving + Inventory Write Kernel — owner-APPROVED, rulings applied, all gates green, **COMMITTED as two commits (`fbc55e6` + docs-sync) — NOT pushed**)
