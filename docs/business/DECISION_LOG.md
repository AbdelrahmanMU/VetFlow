...
### BD-DOC-009 — محاذاة الأرقام في الجداول: حافة البداية، لا اليسار

- **Status:** Approved (owner ruling 2026-08-06)
- **Decision:** **الأرقام في أعمدة الجداول — والمبالغ خاصّةً — تُحاذى بحافة
  البداية** (اليمين في العربية)، **ورأس العمود الرقميّ يُحاذى بالحافة نفسها**
  فيقع العنوان فوق قيمته مباشرة، **والعمود الرقميّ يأخذ عرض محتواه**. النصّ
  السابق في §6 («**الأرقام لليسار**») و§10 («**المبالغ محاذاة يسار في عمودها
  دائمًا») **مُثبَت في موضعه ولم يُمحَ**.
- **Reason:** غاية القاعدة منصوصة في نصّها — «**حتى تصطف الخانات**» — **والنصّ
  السابق كان يُبطلها**: الصفحة RTL لكنّ الرقم يبقى مقطعًا LTR، فتثبيت حافته
  اليسرى يثبّت **أكبر** خاناته وتتبعثر خانة الآحاد والكسر. **قياس فعليّ في
  المتصفح** لعمود «الإجمالي» (1,234.50 · 5.00 · 87.25): عند `end` وقعت مقاطع
  الأرقام في 354–409 · 354–382 · 354–390 — **الحواف اليسرى تتطابق والخانات لا
  تصطف، والعنوان فوق رمز العملة**؛ وعند `start` وقعت في 501–556 · 528–556 ·
  520–556 — **الحواف تتطابق فتصطف الخانات، وحافة العنوان فوق حافة الرقم**.
- **Scope guard — ما لم يتغيّر:** **رفض التوسيط قائم كما هو** (حكم PIT-002،
  2026-08-02)؛ تغيّرت **الحافة** لا غير. **وقاعدة العمود لا تحكم حقل إدخال:**
  «الأرقام لليسار» في **حقل رقم الهاتف** (`digitsFirst`) **سلوكٌ مقصود ولم
  يتغيّر** — محاذاته بحافة البداية تُفسد قراءة الرقم.
- **Source(s):** `docs/ui/design-language.md` §6 و§10 (التعديلان المعتمدان
  والنصّ المنسوخ محفوظًا)، `docs/ui/components.md`,
  `docs/modules/dashboard/ui.md`, `docs/ui/product-editor-ux-architecture.md`,
  `docs/modules/identity/ui.md`
- **Related Module:** كلّ وحدة ذات جدول (Catalog · Inventory · Purchasing ·
  Sales · Categories · Manufacturers · Dashboard) — cross-module
