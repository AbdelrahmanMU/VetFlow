...
| Inventory | `inventory/` | **Approved (Slice 1)** — module proper otherwise pending. **Write Kernel (Receiving support) APPROVED + implemented with Purchasing Slice 5 (2026-07-22): `write-kernel.md` — REQ-INV-001 / BR-INV-001..005 / AC-INV-001..003 / TS-INV-001..003 / DEC-INV-001..002; reference-only links to Catalog/Purchasing, no cascade.** · **Slice 1 Inventory Projection (read model) — DoR APPROVED, owner-ruled (2026-07-22): REQ-INV-002 / BR-INV-006..017 / AC-INV-004..013 / TS-INV-004..013 / DEC-INV-003..007. Low Stock deferred (DEC-INV-004 — future Catalog per-product Reorder Level); Expiring Soon = 30-day global horizon (DEC-INV-005); single read query, no N+1 (DEC-INV-006/BR-INV-017). Implemented & committed (2026-07-29, see STATUS.md).** |
